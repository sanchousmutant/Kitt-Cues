...
export const SCALING_CONFIG = {
  BASE_TABLE_WIDTH: 800, // Увеличено для более гранулированного масштабирования
  BASE_TABLE_HEIGHT: 533,
  BREAKPOINTS: {
    SM: 480,   // для самых маленьких мобильных
    MD: 768,   // для планшетов и больших мобильных
    LG: 1024,  // для небольших ноутбуков
  },
  // Для каждой категории, BASE - это значение по умолчанию для экранов > LG.
  // Размеры в пикселях увеличиваются для маленьких экранов для удобства касания.
  CAT_SCALES: {
    BASE: 1.0,
    LG: 1.0,
    MD: 0.9,
  ...
  BALL_SIZES: {
    BASE: 24, // Базовый размер для десктопа
    LG: 28,
    MD: 32,
    SM: 36,   // Самый большой размер для самых маленьких экранов
  },
  POCKET_SIZES: {
    BASE: 36, // Луза ~1.5x от шара
    LG: 42,
    MD: 48,
    SM: 54,
  },
  CUE_SIZES: {
    ...
    WIDTH_PERCENT: { // Переименовано для ясности
      BASE: 30,
      LG: 35,
      MD: 40,
      SM: 45,
